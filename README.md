# Lichess - Chess.com Soundpack (fix)
JS userscript for [lichess.org](https://lichess.org/) - Fixed version of mickael_r's Chess.com soundpack for Lichess website
...
## How to use it
* Disable Lichess sounds in top right corner to not hear both sounds

You're all set, enjoy Chess.com sounds while playing on Lichess!
